...
function PlatformChangeSheet() {
  const { platformAlertOpen, dismissPlatformAlert, acceptNewPlatformRoute } =
    useSetu();
      ...
      >
        ...
        <div className="mt-3">
          ...
          <p className="txt-base text-navy">
            <Mono className="font-semibold">3 min</Mono> via the Main Foot Over
            Bridge
          </p>
        </div>
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[340px] shrink-0 text-white">
      ...
      <p className="text-white/70 text-sm mt-5 leading-relaxed">
        Navigate the station. Find your way. Travel smarter. Indoor navigation,
        live crowd and passenger assistance for Dadar Railway Station, Mumbai.
      </p>
